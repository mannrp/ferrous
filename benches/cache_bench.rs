...
use ferrous::cache::SimHash;
use ferrous::chunking::MarkdownChunker;
use ferrous::packing::ContextPacker;

fn bench_simhash(c: &Criterion) {
...
fn bench_markdown_chunker(c: &Criterion) {
...
fn bench_context_packer(c: &Criterion) {
